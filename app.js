...
app.post('/gencase',function(req,res){
 ...
 var data =req.body;
 console.log(data);
var url='http://161.202.198.106:9080/ChatAcmService/acm/StartCaseWf?to='+data.location+'&dpt='+data.dpt+'&rtn='+data.rtn+'&adult='+data.adult+'&child='+data.kid+'&seat='+data.seat+'&hotel='+data.hotel+'&cin='+data.dpt+'&out='+data.rtn+'&hadt='+data.adult+'&hchd='+data.kid+'&room='+data.room
console.log(url);
  var options = {
        uri: encodeURI(url),
        method: 'GET'
